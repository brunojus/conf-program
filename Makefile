...
OUTPUTS := program.html program-embed.html program-pdf.html
...
program-pdf.html: $(INPUTS)
	python3 make_joint_program.py --hide-people --font-size=9 --in-table-page-breaks -o program-pdf.html
